...
export default function HeroCanvas() {
  ...
  useEffect(() => {
    ...
    const ringData = [
      { pos: [3.5, 1.5, -3],  color: 0x00BCD4, r: 1.8, tube: 0.04, opacity: 0.45 },
      { pos: [-4, -1, -4],    color: 0xD4A853, r: 1.3, tube: 0.035, opacity: 0.4 },
      { pos: [0.5, 3, -5],    color: 0x006E7A, r: 2.4, tube: 0.05, opacity: 0.3 },
      { pos: [-2, 2.5, -2],   color: 0x00E5FF, r: 0.9, tube: 0.03, opacity: 0.35 },
    ];
    ...
    // Floating icosahedra (gem-like)
    const gemData = [
      { pos: [2, -2, -2],  color: 0x00E5FF, s: 0.25 },
      { pos: [-3, 1, -1],  color: 0xD4A853, s: 0.18 },
    ];
