              ...
              {treatments.map((t) => (
                <tr key={t.id} className="hover:bg-gray-50/50">
                  ...
                  <td className="px-4 py-3">
                    <button onClick={() => setDeleteId(t.id)} className="text-red-400 hover:text-red-600" title="حذف">🗑</button>
                  </td>
                </tr>
              ))}
            </tbody>
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40">
          <div className="w-80 rounded-2xl bg-white p-6 shadow-xl">
            ...
            <div className="flex gap-3">
              ...
              <button onClick={() => setDeleteId(null)} className="flex-1 rounded-lg border border-gray-200 py-2 text-sm font-bold text-clinic-dark hover:bg-gray-50">
                إلغاء
              </button>
            </div>
          </div>
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40">
          <form onSubmit={handleAdd} className="w-full max-w-md rounded-2xl bg-white p-6 shadow-xl">
            ...
            <div className="mt-4 flex gap-3">
              ...
              <button type="button" onClick={() => setShowAdd(false)} className="flex-1 rounded-lg border border-gray-200 py-2.5 text-sm font-bold text-clinic-dark hover:bg-gray-50">
                إلغاء
              </button>
            </div>
          </form>
